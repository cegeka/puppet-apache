...
define apache::vhost(
  ...
  $ip_based                    = false,
  $add_listen                  = true,
  $docroot_owner               = $::apache::params::root_owner,
  $docroot_group               = $::apache::params::root_group,
  $docroot_mode                = $::apache::params::root_mode,
  $serveradmin                 = undef,
  $ssl                         = false,
  ...
  $ssl_honorcipherorder        = $::apache::params::ssl_honorcipherorder,
  ...
  $logroot_owner               = $::apache::logroot_owner,
  $logroot_group               = $::apache::logroot_group,
  $log_level                   = undef,
  $access_log                  = true,
